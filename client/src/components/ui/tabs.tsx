...
>(({ className, centered, fullWidth, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
...
>(({ className, active, pillStyle, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      pillStyle && "rounded-full data-[state=active]:bg-primary data-[state=active]:text-white",
